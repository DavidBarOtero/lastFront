...
function usePaymentCard() {
  ...
  var handleKeyPressCardNumber = React.useCallback(function () {
    ...
    return function (e) {
      ...
      if (e.keyCode !== index.default.ENTER_KEY_CODE) {
  ...
  var handleKeyDownExpiryDate = React.useCallback(function () {
    ...
    return function (e) {
      ...
      if (e.keyCode === index.default.BACKSPACE_KEY_CODE && !e.target.value) {
  ...
  React.useLayoutEffect(function () {
    ...
    if (cardNumberField.current) {
      var cardNumberError = index.default.validator.getCardNumberError(cardNumberField.current.value, {
        errorMessages: errorMessages
      });
      setInputError('cardNumber', cardNumberError);
    }
  }, [cvcValidator, errorMessages, setInputError]); // Format default values
